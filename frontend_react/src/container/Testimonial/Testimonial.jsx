...
const Testimonial = () => {
  ...
  // Since we are using - testimonials[currentIndex] - many times in the jsx, we can take it out save it to a variable and use the variable 
    ...
    <>
      {testimonials.length && (
        <>
          ...
          {/* allow us to move between diferrent testimonials */}
